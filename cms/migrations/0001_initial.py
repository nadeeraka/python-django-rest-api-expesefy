# Generated by Django 3.0.6 on 2020-05-15 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('selection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='savings', to='cms.SavingType')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('update_time', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('name', models.ForeignKey(default='', on_delete=django.db.models.deletion.CASCADE, related_name='incomes', to='cms.IncomeType')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['id'],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('update_time', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='expenses', to='cms.ExpenseType')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['id'],
